# The Partition Key That Broke Production
...
![Partition keys are like organizing a library](images/01_bookshelf_analogy.png)
...
![How partition keys map to physical storage](images/02_partition_mapping.png)
...
![The hot partition problem](images/03_hot_partition.png)
...
![Why adding more capacity doesn't fix a hot partition](images/04_scaling_doesnt_help.png)
...
![Flat vs. hierarchical partition keys](images/05_flat_vs_hierarchical.png)
...
![Partition key decision checklist](images/07_decision_checklist.png)
